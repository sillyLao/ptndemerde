 ...
 *
 */
package net.mcreator.ptndemerde;
...
@Mod("ptndemerde")
public class PtndemerdeMod {
	public static final Logger LOGGER = LogManager.getLogger(PtndemerdeMod.class);
	public static final String MODID = "ptndemerde";

	public PtndemerdeMod() {
