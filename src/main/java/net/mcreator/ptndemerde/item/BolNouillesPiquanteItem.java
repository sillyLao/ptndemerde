...
import net.mcreator.ptndemerde.procedures.BolNouillesPiquantePlayerFinishesUsingItemProcedure;
...
public class BolNouillesPiquanteItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		BolNouillesPiquantePlayerFinishesUsingItemProcedure.execute(entity);
